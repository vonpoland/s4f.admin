                ...
                <div className="panel panel-red">
                    ...
                    {this.props.polls.map(poll =>
                        <div className="panel-footer" key={poll.id}>
                            <span className="pull-left"><Link to={'/interaction/' + poll.id + '/manage'}>Manage</Link></span>
                            <div className="pull-right"><Link to={'/interaction/' + poll.id + '/manage'}><i className="fa fa-arrow-circle-right"></i></Link></div>
